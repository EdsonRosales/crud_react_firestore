...
const LinkForm = (props) => {
    ...
    const handleInputChange = e => {
        ...
        //Copiar valores actuales(...values) y luego el input que estén actualizando (name) coloca los valores actuales que esten typeando ( : value)
    ...
    return (
        <form className="card card-body" onSubmit={handleSubmit}>
            <div className="form-group input-group">
                ...
                <input type="text" className="form-control" placeholder="http://someurl.com" name="url" onChange={handleInputChange} value={values.url}/>
            </div>
